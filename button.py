...
class Button:
    def __init__(self, name, screen, event, coord, button_size=BUTTON_SIZE, color= \
                 pygame.Color(70, 50, 70), font_size= 25): #30):
        self.name = name
        self.event = event
...
#        self.font = pygame.font.SysFont('Unifontttf', font_size)
